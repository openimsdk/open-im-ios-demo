...
class GroupApplicationTableViewController: UITableViewController {
    ...
    private func bindData() {
        _viewModel.applicationItems
            ...
            .drive(tableView.rx.items) { (tableView, row, item: GroupApplicationInfo) in
                ...
                if let state = GroupApplicationTableViewCell.ApplyState.init(rawValue: item.handleResult.rawValue) {
